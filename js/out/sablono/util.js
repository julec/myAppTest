...
var x__29991__auto__ = (((x == null))?null:x);
var m__29992__auto__ = (sablono.util.to_str[goog.typeOf(x__29991__auto__)]);
if(!((m__29992__auto__ == null))){
return m__29992__auto__.call(null,x);
} else {
var m__29992__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__29992__auto____$1 == null))){
return m__29992__auto____$1.call(null,x);
} else {
...
var x__29991__auto__ = (((x == null))?null:x);
var m__29992__auto__ = (sablono.util.to_uri[goog.typeOf(x__29991__auto__)]);
if(!((m__29992__auto__ == null))){
return m__29992__auto__.call(null,x);
} else {
var m__29992__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__29992__auto____$1 == null))){
return m__29992__auto____$1.call(null,x);
} else {
...
var len__30494__auto___40597 = arguments.length;
var i__30495__auto___40598 = (0);
while(true){
if((i__30495__auto___40598 < len__30494__auto___40597)){
args__30501__auto__.push((arguments[i__30495__auto___40598]));

var G__40599 = (i__30495__auto___40598 + (1));
i__30495__auto___40598 = G__40599;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__30502__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq40596){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq40596));
});
...
var vec__40603 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__40605;
var words = seq__40604__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__40611){
var vec__40612 = p__40611;
var k = cljs.core.nth.call(null,vec__40612,(0),null);
var v = cljs.core.nth.call(null,vec__40612,(1),null);
...
return cljs.core.update.call(null,G__40615,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__40615;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__29273__auto__ = x__$1.hasDomain();
