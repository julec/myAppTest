...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__40672){
var vec__40673 = p__40672;
var _ = cljs.core.nth.call(null,vec__40673,(0),null);
var v = cljs.core.nth.call(null,vec__40673,(1),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__40676_SHARP_){
return ((p1__40676_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__40676_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__40678,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__40678;
}
});
...
var len__30494__auto___40681 = arguments.length;
var i__30495__auto___40682 = (0);
while(true){
if((i__30495__auto___40682 < len__30494__auto___40681)){
args__30501__auto__.push((arguments[i__30495__auto___40682]));

var G__40683 = (i__30495__auto___40682 + (1));
i__30495__auto___40682 = G__40683;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__30502__auto__);
});
...
var G__40680 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__40680,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__40680;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq40679){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq40679));
});
...
var vec__40689 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Can't match CSS tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__40689,(0),null);
var names = cljs.core.nth.call(null,vec__40689,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__40689,tag_name,names){
return (function (p1__40684_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__40684_SHARP_))){
return p1__40684_SHARP_;
} else {
return null;
}
});})(matches,vec__40689,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__40689,tag_name,names){
return (function (p1__40685_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__40685_SHARP_));
});})(matches,vec__40689,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__40692){
var vec__40699 = p__40692;
var seq__40700 = cljs.core.seq.call(null,vec__40699);
var first__40701 = cljs.core.first.call(null,seq__40700);
var seq__40700__$1 = cljs.core.next.call(null,seq__40700);
var tag = first__40701;
var content = seq__40700__$1;
...
var vec__40702 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__40702,(0),null);
var id = cljs.core.nth.call(null,vec__40702,(1),null);
var class$ = cljs.core.nth.call(null,vec__40702,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1513965927369