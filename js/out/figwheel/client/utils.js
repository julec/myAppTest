...
var or__29273__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj36724 = {"detail":data};
return obj36724;
})()));
} else {
...
var and__29261__auto____$1 = goog.object.get(window,"CustomEvent");
...
var args36729 = [];
var len__30494__auto___36735 = arguments.length;
var i__30495__auto___36736 = (0);
while(true){
if((i__30495__auto___36736 < len__30494__auto___36735)){
args36729.push((arguments[i__30495__auto___36736]));

var G__36737 = (i__30495__auto___36736 + (1));
i__30495__auto___36736 = G__36737;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args36729.length)].join('')));
...
var f = (function (){var pred__36732 = cljs.core._EQ_;
var expr__36733 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36732.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36733))){
return ((function (pred__36732,expr__36733){
return (function (p1__36725_SHARP_){
return console.warn(p1__36725_SHARP_);
});
;})(pred__36732,expr__36733))
} else {
if(cljs.core.truth_(pred__36732.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36733))){
return ((function (pred__36732,expr__36733){
return (function (p1__36726_SHARP_){
return console.debug(p1__36726_SHARP_);
});
;})(pred__36732,expr__36733))
} else {
if(cljs.core.truth_(pred__36732.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36733))){
return ((function (pred__36732,expr__36733){
return (function (p1__36727_SHARP_){
return console.error(p1__36727_SHARP_);
});
;})(pred__36732,expr__36733))
} else {
return ((function (pred__36732,expr__36733){
return (function (p1__36728_SHARP_){
return console.log(p1__36728_SHARP_);
});
;})(pred__36732,expr__36733))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36739){
...
var opts = map__36742__$1;
var eval_fn = cljs.core.get.call(null,map__36742__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36744_SHARP_);
});})(new_def))
);
...
return (function (p__36745){
var vec__36746 = p__36745;
var ky = cljs.core.nth.call(null,vec__36746,(0),null);
...
var args36749 = [];
var len__30494__auto___36753 = arguments.length;
var i__30495__auto___36754 = (0);
while(true){
if((i__30495__auto___36754 < len__30494__auto___36753)){
args36749.push((arguments[i__30495__auto___36754]));

var G__36755 = (i__30495__auto___36754 + (1));
i__30495__auto___36754 = G__36755;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args36749.length)].join('')));
...
if(cljs.core.truth_((function (){var and__29261__auto__ = typeof localStorage !== 'undefined';
...
}catch (e36752){if((e36752 instanceof Error)){
var e = e36752;
return not_found;
} else {
throw e36752;
